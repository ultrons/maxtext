...
ragged_buffer_factor=-1 num_moe_token_chunks=2 per_device_batch_size=1.0 gradient_accumulation_steps=4"
...
IMGTAG=fixes ENVX="MOE_UNSORT_BWD_MASK=1" bash xpk_variant_2k.sh "$SUF" \
