...
def fill_metadata(
  ...
  size_lhs_group = lhs_group_sizes_ref.shape[0]          # static
  ...
  def body(lid, carry):
    ...
    group_size = lhs_group_sizes_ref[lid]
